 ...
 */
@AutoConfiguration(after = {AuditSecurityAutoConfiguration.class, AuditStoreAutoConfiguration.class})
...
public class AuditAutoConfiguration {
    ...
    @Bean
    public AuditStaticRegistrar auditStaticRegistrar(AuditEventPublisher publisher) {
