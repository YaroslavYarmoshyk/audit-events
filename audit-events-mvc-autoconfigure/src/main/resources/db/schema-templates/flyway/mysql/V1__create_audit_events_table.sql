-- Flyway migration template for the audit-events table (MySQL / MariaDB).
--
...
CREATE TABLE audit_events (
    ...
    INDEX ix_audit_events_type_created_at (type, created_at),
    INDEX ix_audit_events_created_by_created_at (created_by, created_at),
